...
// Endereco do backend.
// Vazio = mesmo servidor que serviu esta pagina (e o caso normal).
// Para rodar so o frontend na sua maquina (ex.: Live Server do VS Code)
// apontando para a API publicada, coloque a URL aqui:
...
async function apiFetch(url, options = {}) {
    ...
    const resposta = await fetch(API_URL + url, { ...options, headers });
